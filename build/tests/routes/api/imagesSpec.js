...
describe('test endpoints for images', function () {
    it('tests /image endpoint', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, req.get('/api/images')];
                case 1:
                    res = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    width = 200;
                    height = 300;
                    return [4 /*yield*/, images_1.default.sharper(name, width, height)];
                case 1:
                    _a.sent();
                    fileExistance = fs_1.default.existsSync("images/thumb/".concat(name, "-").concat(width, "-").concat(height, ".jpg"));
