...
var sharper = function (name, width, height) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!fs_1.default.existsSync('images/thumb')) return [3 /*break*/, 2];
                return [4 /*yield*/, fs_1.promises.mkdir('images/thumb')];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, (0, sharp_1.default)("images/full/".concat(name, ".jpg"))
                    .resize(width, height)
...
var resizer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, fs_1.promises.readFile("images/thumb/".concat(name_1, "-").concat(width, "-").concat(height, ".jpg"))];
            case 2:
                thumb = _a.sent();
