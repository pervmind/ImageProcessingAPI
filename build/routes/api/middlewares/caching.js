    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!fs_1.default.existsSync("images/thumb/".concat(name, "-").concat(width, "-").concat(height, ".jpg"))) return [3 /*break*/, 2];
                return [4 /*yield*/, fs_1.promises.readFile("images/thumb/".concat(name, "-").concat(width, "-").concat(height, ".jpg"))];
            case 1:
                cached = _a.sent();
